          ...
          <div className="bg-white p-4 rounded-lg shadow">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex justify-between">
                <span>Order delivered - Brake Rotors</span>
                <span>2h ago</span>
              </li>
              <li className="flex justify-between">
                <span>Stock updated - Motor Oil</span>
                <span>4h ago</span>
              </li>
              <li className="flex justify-between">
                <span>Low stock alert - Air Filters</span>
                <span>6h ago</span>
              </li>
              <li className="flex justify-between">
                <span>New supplier added - Premium Parts Co.</span>
                <span>1d ago</span>
              </li>
            </ul>
          </div>
